...
<br>
        ...
        <div>
            <input value="{{ old('author', $book->author ?? null) }}"
                   type="text"
                   class="form-control input-lg"
                   id="author"
                   name="author"
...
<br>
        ...
        <div>
            <input value="{{ old('year', $book->year ?? null) }}"
                   type="text"
                   class="form-control input-lg"
                   id="year"
                   name="year"
...
<br>
        <div>
            <label for="content">Напиши описание книги</label>
        </div>
        <div>
            ...
            >{{ old('content', $book->content ?? null) }}</textarea>
        </div>
<br>
